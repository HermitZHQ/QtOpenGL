...
GLuint ShaderHelper::LoadShaders(ShaderInfo *info, GLuint size)
{
	...
	for (GLuint i = 0; i < size; ++i)
	{
		...
		if (!res) {
			AddTipInfo(Q8("�����ļ�ʧ�ܣ�%1").arg(info[i].shaderPath));
			GLchar cLog[520] = { 0 };
...
void ShaderHelper::GetCommonUniformLocation()
{
	if (m_programs[m_shaderType] != 0) {
		AddTipInfo(Q8("��ȡshader�ļ��ɹ�----[%1]").arg(m_shaderType));
	}
	else {
		AddTipInfo(Q8("��ȡshader�ļ�ʧ��----[%1]").arg(m_shaderType));
	}
	...
	if (-1 != skyboxId) {
		// ��ʹ������unit�����Ҽ����˶�Ӧunit������Nsight���Ե�ʱ��Ҳ�ᷢ��Unit0�п���ͬʱ����һ��
		// tex2d��tex cubemap����ô�ǲ���ֻ�ж�cubemap��ʱ�����Ҫ�����أ�
		// ��������������Nsight����֤

		// ��Ϊ�������󣬶�������������ת....����Ȼunit0����ͬʱ����2d��cubemap������Ҫ�����������cubemap��������unit���У���
		// ��ȻҲ���ܺ�����unit�ظ�
...
void ShaderHelper::InitDefaultShader()
{
	...
	if (0)
	{
		...
		if (fp != nullptr) {
			...
			if (GL_FALSE == status) {
				...
				GLint shaderTypeArr[2] = { 0 };
				GLint shaderLenArr[2] = { 0 };
				// �������Եó����ۣ�ʹ��PB load������program���޷��ٴλ�ȡ��shader size����Ч��shader���ݣ�shader sizeΪ0��������
	...
	if (0)
	{
		...
		// ------�õ�program_binary�����ݺ����ǾͿ��԰������浽�ļ����ˣ������´����ǾͿ���ֱ��ʹ�ã���ʡȥ�˴�εĶ�ȡ�ļ����Լ������ʱ����
		char filename[] = "./cache/default.data";
	...
	// uniform block 测试代码段，需要的话可以打开帮助理解
    if (0)
    {
...
GLint ShaderHelper::GetAttriLocation(const GLchar *name)
{
	...
	if (-1 == res) {
// 		AddTipInfo(Q8("�Ҳ���Attrib:%1").arg(name));
		qDebug() << Q8("�Ҳ���Attrib:%1").arg(name);
	}
	return res;
}
...
GLint ShaderHelper::GetUniformLocation(const GLchar *name)
{
	...
	if (-1 == res) {
// 		AddTipInfo(Q8("�Ҳ���uniform:%1").arg(name));
		qDebug() << Q8("�Ҳ���Attrib:%1").arg(name);
	}
	return res;
}